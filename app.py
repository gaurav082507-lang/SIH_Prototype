...
# Display label -> the language name passed to the recommendation model's
# prompt (recommendation_node.py reads state["response_language"] and
# instructs the model to answer in this language).
LANGUAGE_OPTIONS = {
    "English": "English",
    "हिन्दी (Hindi)": "Hindi",
    "தமிழ் (Tamil)": "Tamil",
...
with st.sidebar:
    ...
    response_language_label = st.selectbox(
        "Chat responds in",
        list(LANGUAGE_OPTIONS.keys()),
        key="response_language_label",
    )

    st.session_state.response_language = LANGUAGE_OPTIONS[response_language_label]
